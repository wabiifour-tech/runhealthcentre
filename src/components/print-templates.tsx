        ...
        <CardContent className="p-6">
          ...
          <div className="text-center border-b-2 border-blue-600 pb-4 mb-4">
            <div className="flex items-center justify-center gap-4 mb-2">
              ...
              />
              <div>
                <h1 className="text-2xl font-bold text-blue-800">REDEEMER'S UNIVERSITY HEALTH CENTRE</h1>
        ...
        <CardContent className="p-6">
          ...
          <div className="text-center border-b-2 border-teal-600 pb-4 mb-4">
            <div className="flex items-center justify-center gap-4 mb-2">
              ...
              />
              <div>
                <h1 className="text-2xl font-bold text-teal-800">REDEEMER'S UNIVERSITY HEALTH CENTRE</h1>
      ...
      >
        <div className="flex items-center h-full">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold text-blue-600">REDEEMER'S UNIVERSITY HEALTH CENTRE</p>
        ...
        <CardContent className="p-8">
          ...
          <div className="space-y-4 text-sm leading-relaxed">
            <p>
              ...
              {' '}(Hospital No: <span className="font-bold">{patient.ruhcCode}</span>) was examined at Redeemer's University Health Centre (RUHC).
            </p>
