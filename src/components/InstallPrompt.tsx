        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-4 border border-gray-200 dark:border-gray-700">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-white">Install RUHC HMS</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Add to Home Screen</p>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-4 border border-gray-200 dark:border-gray-700">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-white">Install RUHC HMS</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Works offline • Fast access</p>
              </div>
            </div>
            <button onClick={handleDismiss} className="text-gray-400 hover:text-gray-600">
              <X className="w-5 h-5" />
