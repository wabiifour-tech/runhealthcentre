// Document Templates for Redeemer's University Health Centre (RUHC)
...
export function generatePatientFileName(patient: any, documentType: string, extension: string = 'pdf'): string {
...
export function getPatientFullName(patient: any): string {
