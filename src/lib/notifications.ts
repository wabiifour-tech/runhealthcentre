...
export const NOTIFICATION_TEMPLATES: NotificationTemplate[] = [
  {
    ...
    type: 'sms',
    body: 'Dear {patientName}, this is a reminder of your appointment at Redeemer\'s University Health Centre (RUHC) on {date} at {time}. Please bring your ID card. Reply CANCEL to reschedule.',
  ...
  },
  {
    ...
    type: 'sms',
    body: 'Your appointment at Redeemer\'s University Health Centre (RUHC) has been booked for {date} at {time} with Dr. {doctorName}. Reference: {appointmentId}',
  ...
  },
  {
    ...
    type: 'sms',
    body: 'Dear {patientName}, your lab results are ready. Please visit Redeemer\'s University Health Centre (RUHC) to collect them or check online at runhealthcentre.vercel.app',
  ...
  },
  {
    ...
    type: 'sms',
    body: 'Dear {patientName}, your prescription is ready for pickup at Redeemer\'s University Health Centre (RUHC) Pharmacy. Valid until {expiryDate}.',
  ...
  },
  {
    ...
    type: 'sms',
    body: 'RUHC: You are #{position} in the queue. Estimated wait time: {waitTime} minutes.',
  ...
  },
  {
    ...
    name: 'Queue Call',
    type: 'sms',
    body: 'RUHC: Your turn is NOW! Please proceed to {department}. Queue number: {queueNumber}',
  ...
  },
  {
    ...
    type: 'sms',
    body: 'RUHC: Payment of {amount} received for {service}. Receipt No: {receiptNo}. Thank you!',
  ...
  },
  {
    ...
    name: 'Bill Reminder',
    type: 'sms',
    body: 'Dear {patientName}, you have an outstanding balance of {amount} at Redeemer\'s University Health Centre (RUHC). Please clear to access services.',
  ...
  },
  {
    ...
    type: 'email',
    subject: 'Your Discharge Summary - RUHC',
    body: `Dear {patientName},

Your discharge summary from your recent admission at Redeemer's University Health Centre (RUHC) is ready.
...
Best regards,
Redeemer's University Health Centre (RUHC) Medical Team`,
  ...
  },
  {
    ...
    type: 'email',
    subject: 'Medical Certificate - RUHC',
    body: `Dear {patientName},

Please find attached your medical certificate.

This certifies that you were examined at Redeemer's University Health Centre (RUHC) on {date} and were found to be suffering from {condition}.
...
Best regards,
Dr. {doctorName}
Redeemer's University Health Centre (RUHC)`,
  ...
  },
  {
    ...
    type: 'sms',
    body: 'Welcome to Redeemer\'s University Health Centre (RUHC), {patientName}! Your patient ID is {ruhcCode}. Save this for all visits. Portal: runhealthcentre.vercel.app',
  ...
  },
  {
    ...
    type: 'sms',
    body: 'RUHC: Reminder that {patientName} is due for {vaccineName} vaccination on {date}. Please visit the clinic.',
...
export async function sendNotificationFromTemplate(
  ...
  if (type === 'sms' || template.type === 'sms') {
    ...
    return sendEmail(recipient, template.subject || 'Notification from RUHC', message)
  }
}
    ...
    try {
      ...
      if (notification.options.type === 'email' || notification.options.type === 'both') {
        const result = await sendEmail(
          ...
          notification.options.subject || 'Notification from RUHC',
