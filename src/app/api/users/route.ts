// Users API - PostgreSQL (Neon) Database Operations
...
// GET - Fetch all users (Admin only) - PostgreSQL
...
// POST - Create, update, or delete users - PostgreSQL
export async function POST(request: NextRequest) {
  try {
    ...
    if (action === 'update') {
      ...
      let viewablePassword: string | null = null
...
// DELETE - Delete a user - PostgreSQL
