...
// Helper to generate filename from patient data
function getDocumentFileName(patient: any, documentType: string): string {
  return generatePatientFileName(patient, documentType.replace(/_/g, '_'));
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ 
      ...
      fileName: getDocumentFileName(data.patient, documentType)
    });
